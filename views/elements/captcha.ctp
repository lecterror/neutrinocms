...
<img id="captcha" src="<?php echo $html->url(array('controller' => 'comments', 'action' => 'captcha', strval(rand(100,999)))); ?>" alt="Captcha spam prevention image" title="Click to reload the image if it is unreadable!" />
</a>